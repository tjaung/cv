...
export default function PreprocessingWriteup() {
  return <details className="panel preprocessing-writeup" open>
    ...
    <article className="preprocessing-writeup-content">
      ...
      <p>{"I initially had an idea of normalizing colors to the intensity midpoint. Given a percentage, all colors under mid point would increase luminance by that percentage capping at mid point, and opposite for brighter colors. I initially thought this did not make much of a difference from looking at the images and histograms, so I removed it. After retraining, I found that the anomaly model lost a lot of its scratch detection, while both whole-plate CNNs improved and the classifier results were mixed. I now want to compare the preprocessing choices for anomaly detection more directly. It has options for the full pipeline with or without luminance normalization, and raw images with features only. Classifiers and CNNs still use their existing pipelines without luminance correction."}</p>
