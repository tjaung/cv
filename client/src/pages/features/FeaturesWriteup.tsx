...
export default function FeaturesWriteup() {
  return <details className="panel preprocessing-writeup" open>
    ...
    <article className="preprocessing-writeup-content">
      ...
      <p>In my initial testing, models using these two feature groups struggled with scratches. They did better on good plates and rust, which made me question whether I was capturing enough of the scratch patterns. My preprocessing also did not bring out scratches as much as I would have wanted, so I wanted features that could pick up their local patterns better. I added HOG because it uses the Sobel gradients to summarize the strength and orientation of edges in small regions. My hope was that this would help capture the repeated lines in scratches. I also added a Frangi filter to bring out thin, ridge-like patterns at different sizes, although glare and other structures can show up too. I saw better results later, but I changed preprocessing as well. I would need to add each feature group separately under the same conditions to measure how much HOG and Frangi each helped.</p>
      <p>Some other features looked less promising in my visual checks. I thought local binary patterns could potentially find scratches as well, but I did not see strong signals in the examples I inspected. Trying that did give me the idea of doing the localized region predictions.</p>
