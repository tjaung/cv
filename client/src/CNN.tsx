...
export default function CNN() {
  ...
  return <section className="cnn-page"><div className="page-intro"><h2>CNN · ResNet-18</h2><p>Whole-plate and localized patch classification on segmented color plates. All layers are fine-tuned from ImageNet weights. Uses the shared 80/20 split with seed 42, then the pretrained weights’ resize, center crop and normalization.</p></div>
